...
/* One list for everything with a date on it: renewals read off documents,
   birthdays derived from the household's people, and the dates someone typed
   in by hand. Pure shaping — the caller loads the rows. */

export type ComingUpKind = "document" | "birthday" | "event";
